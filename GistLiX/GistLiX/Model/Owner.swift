...
class Owner: Model {
	public var login = Observable<String?>(nil)
	public var id = Observable<Int?>(nil)
	public var avatar_url = Observable<String?>(nil)
	public var gravatar_id = Observable<String?>(nil)
	public var url = Observable<String?>(nil)
	public var html_url = Observable<String?>(nil)
	public var followers_url = Observable<String?>(nil)
	public var following_url = Observable<String?>(nil)
	public var gists_url = Observable<String?>(nil)
	public var starred_url = Observable<String?>(nil)
	public var subscriptions_url = Observable<String?>(nil)
	public var organizations_url = Observable<String?>(nil)
	public var repos_url = Observable<String?>(nil)
	public var events_url = Observable<String?>(nil)
	public var received_events_url = Observable<String?>(nil)
	public var type = Observable<String?>(nil)
	public var site_admin = Observable<Bool?>(nil)


    class func modelsFromDictionaryArray(array:NSArray) -> [Owner]
    {
        var models:[Owner] = []
        for item in array
        {
            models.append(Owner(json: item as! JSON))
        }
        return models
    }
